...
Установка Developer Kit в ветку `docs/project-documentation` без изменения рабочего кода.

## Следующие шаги

1. Проверить документационный Pull Request и отсутствие изменений приложения.
