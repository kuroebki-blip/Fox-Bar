...
| --- | --- | --- | --- |
| FO’X frontend | `v15.15.8 CALENDAR SHIFT LOAD FIX` | готовится к публикации из `main` | скрывает личный список смен, выделяет сегодня и восстанавливает загрузку персонала выбранной даты |
