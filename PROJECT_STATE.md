...
Candidate: Tatooine `v1.5.0` готовит встроенную заднюю камеру для Telegram WebView на Android. iPhone сохраняет существующий file-input путь. Живой тест на Android ещё не выполнен.

## Следующие шаги

1. Проверить открытие, разрешение, снимок и fallback камеры внутри Telegram на Android.
